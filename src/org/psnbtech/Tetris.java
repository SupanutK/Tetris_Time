...
import org.psnbtech.BoardPanel.STATE;
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (State == STATE.GAME) {
					 ...
					 * current position is valid. If so, we decrement the
					 * current column by 1.
					 */
					case KeyEvent.VK_A:
						if (!isPaused
					 ...
					 * piece anticlockwise. Because of the size and complexity
					 * of the rotation code, as well as it's similarity to
					 * clockwise rotation, the code for rotating the piece is
					 ...
					 * we unpause if we stay paused for more than a minute or
					 * so.
					 */
					case KeyEvent.VK_P:
			...
			public void keyReleased(KeyEvent e) {
				 ...
				 * back to whatever the current game speed is and clear out any
				 * cycles that might still be elapsed.
				 */
				case KeyEvent.VK_S:
